...
$sql = "SELECT title, description, event_date, image_url FROM Events ORDER BY event_date";
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-2 text-dark mb-4 animated slideInDown">Events</h1>
                ...
                <?php foreach ($events as $index => $event): ?>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="<?= 0.1 + $index * 0.2 ?>s">
                        <div class="store-item position-relative text-center">
                            <img class="img-fluid" src="<?= htmlspecialchars($event['image_url']) ?>" alt="<?= htmlspecialchars($event['title']) ?>">
                            <div class="p-4">
                                <h4 class="mb-3"><?= htmlspecialchars($event['title']) ?></h4>
                                <p><?= htmlspecialchars($event['description']) ?></p>
                                <h4 class="text-primary"><?= date('jS F Y', strtotime($event['event_date'])) ?></h4>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
